...
public class login_activity extends AppCompatActivity {
        ...
        View Mview;
        EditText UserTxtInput;
        EditText PassTxtInput;
        Button LoginButt;
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            UserTxtInput = (EditText) findViewById(R.id.UserTxtInput);
            PassTxtInput = (EditText) findViewById(R.id.PassTxtInput);

            //////////////////////////////////////////////////////////////////////////
            PassTxtInput.setOnFocusChangeListener(new View.OnFocusChangeListener() {
                @Override
                public void onFocusChange(View v, boolean hasFocus) {
                    PassTxtInput.setText("");
                }
            });
            ...
            LoginButt.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (UserTxtInput.getText().toString().isEmpty() || PassTxtInput.getText().toString().isEmpty()) {
                        UserTxtInput.setText("Empty");
                        PassTxtInput.setText("Empty");
                    }
                    mAuth.signInWithEmailAndPassword(UserTxtInput.getText().toString(), PassTxtInput.getText().toString())
                            .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    if (task.isSuccessful() && mAuth.getCurrentUser().isEmailVerified()) {
                                        ...
                                        soulboundDevice(true, UserTxtInput.getText().toString()); //RememberCheckBox On TRUE
                                    }
